...
namespace CodeAnalysis
{
  ...
  public interface IAction
  {
    ...
    void doActionA(CSsemi.CSemiExp semi);
  }

  public interface IActionA
  {
  ...
  public abstract class AAction : IAction
  {
    ...
    public abstract void doActionA(CSsemi.CSemiExp semi);
  ...
  public abstract class AActionA : IActionA
  {
      static bool displaySemi_ = false;   // default
      static bool displayStack_ = false;  // default
  ...
  public abstract class ARule : IRule
  {
    ...
    public void doActionsA(CSsemi.CSemiExp semi)
    {
        foreach (IAction action in actions)
            action.doActionA(semi);
    }
